...
public class DatePickerBuilder {
   ...
   /* @Deprecated
    ...
    public DatePickerBuilder setTodayLabelColor(@ColorRes int color) {
        mCalendarProperties.setTodayLabelColor(ContextCompat.getColor(mContext, R.color.daysLabelColor));
        return this;
    }
    ...
    public DatePickerBuilder setDaysLabelsColor(@ColorRes int color) {
        mCalendarProperties.setDaysLabelsColor(ContextCompat.getColor(mContext, R.color.daysLabelColor));
        return this;
    }
